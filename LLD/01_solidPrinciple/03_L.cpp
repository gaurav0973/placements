...
what it does ?
    - Object of childClass should be able to replace object of parentClass without affecting the functionality
    - derived classes must be substitutable for their base classes
How to achieve this ?
    - use inheritance + interface(abstract classes) where it is breaking and find the relationship
    - ensure that derived classes implement the same interface as the base class
*/
